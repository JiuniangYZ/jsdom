...
const { idGetter } = require('../../utils');
const { wrapperSymbol } = require('../generated/utils');
...
class NodeImpl extends EventTargetImpl {
  constructor(globalObject, args, privateData) {
    ...
    // TODO:编码shadow_id的入口
    this._shadow_id = idGetter();
    this._event_handler_counter = new Map(); // string=>number
  }

  _getWrapper(){
    return this[wrapperSymbol] ?? null;
  }
  ...
  get eventHandlerCounter(){
    return this._event_handler_counter;
  }
