...
class EventImpl {
  ...
  set innerDetail(_ = {}){
    if(typeof _ !== 'object') throw new Error('plz use object to set inner_detail');
    Object.assign(this.__inner_detail__, _)
  }

  get innerDetail(){
    return {...this.__inner_detail__}
  }
